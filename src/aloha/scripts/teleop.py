...
#  Notes:
#  The teleop.py opening ceremony is different than the record_episodes.py opening ceremony
        ...
        for leader_name, leader_bot in robots.items():
            if 'leader' in leader_name:
                ...
                if follower_bot:
                    ...
                    # printing here is RISKY.
                    # rclpy CANNOT handle locking the leader arm here if early exist.
                    # print(f"Gripper command for {follower_name}: {gripper_command}")
