...
# Feb 23
START_ARM_POSE = WIPE_BOARD_START_POSE = [
    0.0, -0.6, 0.5, 0.0, 1.2, 0.0, 0.04, -0.04,
    0.0, -0.6, 0.0, 0.0, 1.2, 0.0, 0.04, -0.04,
]
...
# ONLY GRIPPER JOINT VALUES ARE USED, NOT GRIPPER POSITION VALUES (ABOVE)
...
FOLLOWER_GRIPPER_JOINT_MID = (
    FOLLOWER_GRIPPER_JOINT_OPEN + FOLLOWER_GRIPPER_JOINT_CLOSE)/2

FOLLOWER_GRIPPER_JOINT_GRAB = (
    FOLLOWER_GRIPPER_JOINT_OPEN + FOLLOWER_GRIPPER_JOINT_CLOSE)/2.5
