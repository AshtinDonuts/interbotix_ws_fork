...
def enable_gravity_torque(bot: InterbotixManipulatorXS):
    MyGravityTorqueInterface(bot.core)
...
# PRE-JAN 6
# START_ARM_POSE = [
#     0.0, -0.96, 0.9, 0.0, 0.4, 0.0, 0.02239, -0.02239,
#     0.0, -0.96, 0.9, 0.0, 0.4, 0.0, 0.02239, -0.02239,
# ]

# Jan 7
# use for torque experiemnts, high starting vantage point
START_ARM_POSE = [
    0.0, -0.6, 0.5, 0.0, 1.2, 0.0, 0.02239, -0.02239,
    0.0, -0.6, 0.0, 0.0, 1.2, 0.0, 0.02239, -0.02239,
]

# # # FEB 5 # SSIL replay experiments
# START_ARM_POSE = [
#     0.046, -0.60, 0.85, 0.003, 0.0, 0.006, 0.02239, -0.02239,
#     0.046, -0.60, 0.85, 0.003, 0.0, 0.006, 0.02239, -0.02239,
# ]

# ## feb 7 - ssil terminal
# START_ARM_POSE = [
#     0.12732, -0.535359, 1.185767, 0.245437, -0.684155, -0.193282, 0.02239, -0.02239,
#     0.12732, -0.535359, 1.185767, 0.245437, -0.684155, -0.193282, 0.02239, -0.02239,
# ]

# # # FEB 8 - Green ball
# START_ARM_POSE = [
#     -0.0997, -0.431, 0.9388, 0.1058, 0.5706, -0.3145, 0.02239, -0.02239,
#     -0.0997, -0.431, 0.9388, 0.1058, 0.5706, -0.3145, 0.02239, -0.02239,
# ]

# # # FEB 8 - Green ball START high
# START_ARM_POSE = [
#     0.0, -0.9, 0.9, 0.0, 0.9, 0.0, 0.02239, -0.02239,
#     0.0, -0.9, 0.9, 0.0, 0.9, 0.0, 0.02239, -0.02239,
# ]

# # # FEB 8 - Green ball START high 2
# START_ARM_POSE = [
#     0.2, -0.7, 0.9, 0.0, 0.9, 0.0, 0.02239, -0.02239,
#     0.2, -0.7, 0.9, 0.0, 0.9, 0.0, 0.02239, -0.02239,
# ]
...
FOLLOWER_GRIPPER_JOINT_OPEN = 1.74  ## 1.8
FOLLOWER_GRIPPER_JOINT_CLOSE = 0.65  ## 0.6197
...
def LEADER_GRIPPER_VELOCITY_NORMALIZE_FN(
    x): return x / (LEADER_GRIPPER_JOINT_OPEN - LEADER_GRIPPER_JOINT_CLOSE)
...
def FOLLOWER_GRIPPER_VELOCITY_NORMALIZE_FN(
    x): return x / (FOLLOWER_GRIPPER_JOINT_OPEN - FOLLOWER_GRIPPER_JOINT_CLOSE)
